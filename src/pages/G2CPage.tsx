...
export default function G2CPage() {
  ...
  const g2cServices = [
    ...
    },
    {
      ...
      shortName: "Vaccine Registration",
      description: "COVID-19 vaccine registration and vaccination services",
      fullDescription:
        "Professional assistance with COVID-19 vaccine registration, appointment booking, and vaccination support. Get help with CoWIN portal registration and vaccination scheduling.",
      icon: <Heart className="w-8 h-8" />,
      ...
      features: [
        ...
        "CoWIN portal assistance",
        "Vaccination appointment booking",
        "Vaccination certificate download",
      ],
      eligibility: "All Indian citizens and residents",
      documents: ["Aadhaar Card", "Mobile Number", "Photo ID", "Address Proof"],
      process:
        "Register → Book Appointment → Get Vaccinated → Download Certificate",
    ...
    },
    {
      id: "csc-services",
      name: "CSC Services",
      shortName: "CSC Services",
      description: "Common Service Centers and Digital Seva Centers services",
      fullDescription:
        "Professional assistance with Common Service Centers (CSC) and Digital Seva Centers services. Access various government and private services through CSC network.",
      icon: <Building className="w-8 h-8" />,
      ...
      features: [
        "CSC registration and services",
        "Digital Seva Centers access",
        "Government service facilitation",
        "Digital literacy programs",
      ],
      eligibility: "All citizens and residents of India",
      documents: ["Aadhaar Card", "Mobile Number", "Address Proof", "Photo"],
      process: "Visit CSC → Register → Access Services → Complete Transactions",
    ...
    },
    {
      ...
      description: "Digital governance centers and e-governance services",
      fullDescription:
        "Professional assistance with e-governance services and digital governance centers. Access various government digital services and online applications.",
      icon: <Globe className="w-8 h-8" />,
      ...
      process:
        "Register → Verify Identity → Access Services → Complete Applications",
    ...
    },
    {
      ...
      shortName: "RTO Tax Payment",
      description: "Vehicle tax payment, road tax payment, and RTO services",
      fullDescription:
        "Professional assistance with RTO tax payment services including vehicle tax payment, road tax payment, motor vehicle tax, and other RTO-related services.",
      icon: <CreditCard className="w-8 h-8" />,
      ...
      eligibility: "Vehicle owners and operators",
      documents: [
      ...
      process: "Submit Documents → Calculate Tax → Make Payment → Get Receipt",
